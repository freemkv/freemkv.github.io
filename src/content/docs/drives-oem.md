...
description: How freemkv works with a normal, off-the-shelf optical drive. Covers DVDs, the legitimate AACS handshake for Blu-ray and 4K UHD, and why stock drives can be slow ("rip-lock").
---
