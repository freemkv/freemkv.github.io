...
- **Pass 1 — sweep.** A sequential read of the whole disc, tolerant of bad sectors. When a sector won't read, freemkv records the range and skips ahead instead of aborting — one bad spot never costs you the rest of the disc.
